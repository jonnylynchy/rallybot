...
FlagAlerts.prototype.make = function(name, pinNum) {
...
FlagAlerts.prototype.reset = function() {
  _.forEach(this.flags, function(flag) {
    flag.to(0);
  });
};

FlagAlerts.prototype.raise = function(color) {
  this.flags[color].to(90);
};

module.exports = new FlagAlerts();
